...
["Статистика в табличном виде", "Загрузка файлов таблицы с оценками(.csv,.txt,.xlsx) для дальнейшего расчета статистики. Вывод статистики в табличном виде"],
["Статистика в графическом виде","Вывод статистики в Графическом виде"],
["Справка","Описание для всех вкладок"],
    ...
    if (fileName.includes(".csv")) {
        Papa.parse(InputedTableFile2.files[0], {
            ...
            complete: (results) => {
                ...
                let headers = ['Класс', 'Средний балл', 'Медиана', '5', '4', '3', '2'];
                let classesData = [];
                ...
                TableBuilderTabularOutput2.update(getDisciplinesData(classes, true), ['Предмет', 'Средний балл', 'Медиана', '5', '4', '3', '2']);
